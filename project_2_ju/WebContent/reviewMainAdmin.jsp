...
<head>
<meta charset="UTF-8">
<title>리뷰목록 관리자 페이지</title>
<link rel="stylesheet" href="css/header.css">
<link rel="stylesheet" href="css/rvMain.css">
<script src="https://code.jquery.com/jquery-3.7.1.min.js"></script>

<script>
	function reviewDelete(frm) {
	    let rDelete = confirm("정말로 삭제하시겠습니까?");
	    if (rDelete) {
	    	frm.action = "reviewDeleteOk.jsp";
	    	frm.submit();
	    } else {
	    }
	}
	...
	<c:forEach var="vo" items="${list}">
		<tbody id="reviewOne">
	        ...
	        <tr>
	            ...
	            <td><input type="button" value="신고" onclick="warn_push()">
	            <input type="button" value="삭제" onclick="reviewDelete(this.form)">
