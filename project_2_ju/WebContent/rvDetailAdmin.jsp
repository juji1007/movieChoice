...
<%
		//rvMain에서 클릭
		response.sendRedirect("reviewController?category=rvMain&location=reviewMainAdmin&cPage=" + cPage);
		//selectOne에서 클릭
...
<!-- 		</form> -->
	...
	<td>
		<input class="li_button"  type="button" value="목록" onclick="javascript:location.href='reviewController?category=rvMain&location=reviewMainAdmin&cPage=${cPage}'">
	</td>
	</tr>
